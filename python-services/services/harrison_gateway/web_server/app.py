...
from services.harrison_gateway.config import get_config
...
def get_app() -> FastAPI:
    ...
    app = BaseFastAPI(title="Harrison API Gateway")
    app.add_middleware(
        CORSMiddleware,
    ...
    ReverseProxy("/marketing", web_server_config.MARKETING_API_HOST).config_app(app)
