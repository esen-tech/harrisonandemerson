...
const AppointmentCreateServiceProductPage = () => {
  const router = useRouter()
  const { organization_uuid } = router.query
  const createServiceProductForm = useForm({
    defaultValues: {
      service_product_internal_users: [],
    },
  })
  const createServiceProductFormServiceProductInternalUserFieldArray =
    useFieldArray({
      control: createServiceProductForm.control,
  ...
  const watchSelectedServiceProductInternalUser =
    createServiceProductForm.watch(
  ...
  const appendedServiceProductInternalUserReferences = createServiceProductForm
    .getValues()
  ...
  const handleSubmitAppendServiceProductInternalUserForm = async (payload) => {
    payload.internal_user_references.forEach((internal_user_reference) => {
      createServiceProductFormServiceProductInternalUserFieldArray.append({
  ...
  const handleSubmitCreateServiceProductForm = async (payload) => {
          ...
          rightControl={
            <Inline gap="s">
              ...
              <Button
                variant="primary"
                inversed
                onClick={createServiceProductForm.handleSubmit(
                  handleSubmitCreateServiceProductForm
                )}
              >
                建立服務
              </Button>
                ...
                <Stack gap="xxl">
                  ...
                  <Stack gap="l" fluid>
                    ...
                    <Input
                      fluid
                      placeholder="填入服務名稱"
                      {...createServiceProductForm.register('display_sku_key')}
                    />
                  </Stack>
                  <Stack gap="l" fluid>
                    ...
                    <Field as={Stack} fluid>
                      ...
                      <Input
                        ...
                        placeholder="填入掛號費用"
                        type="number"
                        {...createServiceProductForm.register(
                    ...
                    <Field as={Stack} fluid>
                      ...
                      />
                      {createServiceProductForm.formState.errors
                        .durationInMinutes ? (
                    ...
                    <Field as={Stack} fluid>
                      ...
                      <Textarea
                        ...
                        {...createServiceProductForm.register('display_note')}
                      />
                    </Field>
                  </Stack>
                </Stack>
                  ...
                  <Stack gap="l" fluid>
                    ...
                    <Field as={Stack} fluid>
                      ...
                      <Input
                        fluid
                        type="datetime-local"
                        {...createServiceProductForm.register('effective_time')}
                      />
                    </Field>
                    <Field as={Stack} fluid>
                      <Label size="s" variant="secondary">
                      ...
                      <Input
                        fluid
                        type="datetime-local"
                        {...createServiceProductForm.register('expire_time')}
                      />
                    </Field>
                  </Stack>
                  <Stack gap="l" fluid>
                    <Heading size="s">服務人員</Heading>
                    {createServiceProductFormServiceProductInternalUserFieldArray.fields.map(
                      (field, idx) => {
                        const values = createServiceProductForm.getValues()
        ...
        >
          <Stack fluid gap="xl">
            ...
            <Button
              ...
              variant="negative"
              onClick={() => {
                createServiceProductFormServiceProductInternalUserFieldArray.remove(
                  selectedServiceProductInternalUserIndex
                )
...
export default AppointmentCreateServiceProductPage
